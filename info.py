...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'ANUJVIRUS') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "@ANUJVIRUS") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002899700154').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002705703955'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002705703955'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002891224618'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002891224618')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002891224618'))

# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "HDDATABASE")

# Files index database url
FILES_DATABASE = environ.get('FILES_DATABASE', "")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'HDCOLLECTION')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002829933094'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002582982387'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002796809199') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002779754485')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ANUJVIRUS')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/HDMovieFINDER')
...
SHORTENER_API = environ.get("SHORTENER_API", "not yet")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'not yet')
SHORTENER_API2 = environ.get("SHORTENER_API2", "not yet")
...
START_IMG = (environ.get('START_IMG', 'https://ibb.co/bgKt0Nyy')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://ibb.co/WvJLXB3c")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://ibb.co/RTM0znRF')).split()
