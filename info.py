...
BOT_TOKEN = environ.get('BOT_TOKEN', '8473091335:AAGSSmCiooXKtJgzLjxXWIJBFizeDHX_5Wg')
PORT = environ.get('PORT', '8082')

# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7042953166').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Hishammon') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "Hishammon") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002974352702').split()]
...
# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Auto:Auto@cluster0.l9bsmbl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003188543488')) 
